...
class UBE_Element_Lustria_Posts_Slider extends G5P_Elements_Listing_Blog_Abstract
{
	public function get_name()
	{
		return 'lustria-posts-slider';
	}
	...
	{
		return esc_html__('Lustria Posts Slider', 'lustria-framework');
	}

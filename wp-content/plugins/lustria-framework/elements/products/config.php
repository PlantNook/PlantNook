...
class UBE_Element_Lustria_Products extends G5Shop_Abstracts_Elements_Listing {
	public function get_name()
	{
		return 'lustria-products';
	}
	public function get_title()
	{
		return esc_html__('Lustria Products', 'lustria-framework');
	}

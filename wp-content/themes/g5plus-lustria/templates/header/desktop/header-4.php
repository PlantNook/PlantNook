...
$header_above_border = G5Plus_Lustria()->options()->get_header_above_border();
...
$header_customize_left = G5Plus_Lustria()->options()->get_header_customize_left();
$header_customize_right = G5Plus_Lustria()->options()->get_header_customize_right();
    ...
    <div class="<?php echo esc_attr($header_above_class); ?>">
        <div class="container">
            <div class="<?php echo esc_attr($header_above_inner_class) ?>">
                ...
                <?php else: ?>
                    <?php G5Plus_Lustria()->helper()->getTemplate('header/header-customize', array('customize_location' => 'left', 'canvas_position' => 'left')); ?>
                <?php endif; ?>
                ...
                <?php if(empty($header_customize_right)): ?>
                    <div class="header-customize-empty"></div>
                <?php else: ?>
                    <?php G5Plus_Lustria()->helper()->getTemplate('header/header-customize', array('customize_location' => 'right', 'canvas_position' => 'right')); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
